...
In einem \textbf{Mehrwegebaum} kann jeder Knoten eine variable Anzahl von Kindern besitzen. 
...
Der Wert eines Minimum-Knotens ist das Minimum der Werte seiner Kinder. 
Der Wert eines Maximum-Knotens ist das Maximum der Werte seiner Kinder.    
